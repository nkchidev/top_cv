                                        ...
                                        <div class="col-md-8 img-title_job-description">
                                            ...
                                            <div class="description-post">
                                                ...
                                                <span class="btn-introduce-post"
                                                    style="color:black;">{{ $company->industry }}</span>
                                                <span class="btn-introduce-post"
                                                    style="color:black;">{{ $company->number_of_employees }}</span>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                        </div>
                            ...
                            <div class="post_introduce_company">
                                ...
                                <div class="detail_introduce_company">
                                    <div class="name_company">
                                        <a href="{{ route('company.detail', [$hot_company->id]) }}">{{ $hot_company->name }}</a>
                                    </div>
                                    <div class="detail">
                                        <button>
                                            <a
                                                href="{{ route('company.detail', [$hot_company->id]) }}">
                                                Tìm hiểu ngay
                                            </a>
                                        </button>
                                    </div>
