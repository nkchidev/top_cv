...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="company_detail" style="padding:0 130px 40px;">
                <div class="company_detail_header">
                    <div style="position: relative;">
                        <div>
                            <img src="{{ asset('storage/' . $list_images[0]->image) }}" alt=""
                        ...
                        <div
                            ...
                            <div style="padding: 10px 270px;">
                                ...
                                <div class="link-number_employ">
                                    <ul>
                                        <li><i class="fa-solid fa-globe" id="link-number_employ_icon"></i> <a
                                                href="#" style="color: white;">{{ $company->website }}</a></li>
                                        <li><i class="fa-solid fa-building" id="link-number_employ_icon"></i> <a
                                                href="#" style="color: white;">{{ $company->number_of_employees }}
                                                nhân viên</a></li>
                                        <li><i class="fa-solid fa-users" id="link-number_employ_icon"></i> <a
                                                href="#" style="color: white;">{{ $company->number_employ }} người
                                                theo dõi</a></li>
                                    </ul>
                                    <style>
                                        .company_detail {
                ...
                <div class="company_detail_logo"
                    style="margin-top: -252px;z-index: 100;position: absolute;margin-left: 43px;">
                                        ...
                                        <div class="row">
                                            <div class="col-md-8 img-title_job-description">
                                                <div class="description-post">
                                                    <h3 class="title-job">Số lượng bài tuyển dụng :
                                                        {{ $posts->count() }}</h3>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-8 img-title_job-description">
                                            ...
                                            <div class="description-post">
                                                <h3 class="title-job"><a
                                                        href="{{ route('post.detail', [$post->id, $post->slug]) }}">{{ $post->title }}</a>
                                                </h3>
                                                <div class="company-name">{{ $post->company_name }}</div>
                                                <span class="btn-introduce-post"
                                                    style="color:black;">{{ $post->min_salary }}
                                                    {{ $post->unit_money }} - {{ $post->max_salary }}
                                                    {{ $post->unit_money }}</span>
                                                <span class="btn-introduce-post" style="color:black;">Hết hạn -
                                                    {{ $post->expired_post }}</span>
                                                <span class="btn-introduce-post"
                                                    style="color:black;">{{ $post->city }}</span>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="post_time">
