    ...
    <div id="main-post_detail">
        ...
        <div class="infor_company" id="infor_company">
            <div class="header_infor_company">
                ...
                <span><a href="{{route('company.detail',$detail_post->company_id)}}">Xem trang công ty <i class="fa-solid fa-location-arrow"></i></a> </span>
            </div>
