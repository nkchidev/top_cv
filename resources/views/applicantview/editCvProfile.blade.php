                    ...
                    <div class="main_edit_profile">
                        <form action="{{ route('update.cv.applicant', $cv_user->id ?? '') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="infor_yourself" id="infor_yourself">
                                        ...
                                        <div class="infor_input">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" placeholder="Vui lòng nhập số điện thoại"
                                                    name="phoneNumber" value="{{ $cv_user->phoneNumber ?? '' }}">
                                            </div>
                                        </div>
                                        <div class="infor_input">
                                            ...
                                            <div class="col-md-8">
                                                <select name="gender" id="" class="gender_select"
                                                    value="{{ $cv_user->gender ?? '' }}">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="upload_img_avatar">
                                            <div class="avatar_upload">
                                                <img src="{{ asset('storage/' . $cv_user?->avatar) }}" alt=""
                                                    name="avatar" id="avatar">
                                            </div>
                                            <div class="">
                                                <input type="file" name="avatar" id="avatar_upload">
                                                <label for="avatar_upload" class="lable_upload_avatar">Tải ảnh
                                                    lên</label>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="infor_input">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" placeholder="Nhập địa chỉ cụ thể" name="address"
                                                value="{{ $cv_user->address ?? '' }}">
                                        </div>
                                    </div>
                                    <div class="infor_input">
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" placeholder="https://github.com/username"
                                                name="links" value="{{ $cv_user->links ?? '' }}">
                                        </div>
                                    </div>
                                    <div class="infor_input">
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            @if ($cv_user?->filecv)
                                                <div class="col-md-2">
                                                    <a href="{{ asset('storage/' . $cv_user?->filecv ?? '') }}"
                                                        target="_blank">{{ $cv_user->filecv ?? '' }}</a>
                                                </div>
                                            @endif
                                ...
                                <p class="warning_text">Chú ý: không được để trống các thông tin bắt buộc có kí tự (*)
                                </p>
                            </div>
                            <div class="introduce_yourself_form hooby" id="your_hooby">
                                <h5 class="title_edit_form"><i class="fa-regular fa-pen-to-square"></i> GIỚI THIỆU BẢN
                                    THÂN </h5>
                                <textarea name="introduce_yourself" id="introduce_yourself" rows="10"
                                    placeholder="giới chịu đôi chút về bản thân VD( nơi sinh, tuổi tác, đam mê nghề nghiệp như nào, sở thích)">
                                        <div>
                            ...
                            <div class="introduce_yourself_form hooby" id="your_study">
                                <h5 class="title_edit_form"><i class="fa-solid fa-graduation-cap"></i></i> HỌC VẤN
                                </h5>
                                <textarea name="study_degree" id="study_degree" rows="10"
                                    placeholder="giới chịu đôi chút về bản thân VD( nơi sinh, tuổi tác, đam mê nghề nghiệp như nào, sở thích)">
                                        <div>
                            ...
                            <div class="introduce_yourself_form exp" id="your_exp">
                                <h5 class="title_edit_form"><i class="fa-solid fa-briefcase"></i> KINH NGHIỆM LÀM VIỆC
                                </h5>
                                <textarea name="experience" id="experience" rows="10"
                                    placeholder="giới chịu đôi chút về bản thân VD( nơi sinh, tuổi tác, đam mê nghề nghiệp như nào, sở thích)">
                                        <div>
                                        {{ $cv_user?->experience }}
                                        </div>
                            ...
                            <div class="introduce_yourself_form language_skill" id="your_language_skill">
                                <h5 class="title_edit_form"><i class="fa-solid fa-graduation-cap"></i> KỸ NĂNG LẬP
                                    TRÌNH </h5>
