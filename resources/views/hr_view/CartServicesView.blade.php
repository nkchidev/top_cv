                ...
                <div class="cart" style="display:flex">
                    ...
                    <div class="cart-title-left colum-8">
                            ...
                            <div class="cart-item">
                                <div class="colum-4">
                                    ...
                                    <div class="detail_introduce_company">
                                            <div class="img_introduce-company">
                                                <img src="https://cdn-new.topcv.vn/unsafe/https://static.topcv.vn/v4/image/welcome/section-header/toppy-hr-tech.png" alt="">
                                            </div>
                                ...
                                <div class="colum-3">
                                    <div class="count" style="font-size:20px">
                                        <p>{{number_format($service->price)}} VND</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="bill-tt" style="background-color:#f2fbf6">
                                ...
                                <div class="fee colum-10">
                                    ...
                                    <div class="value colum-3-5">
                                        <span class="count-fee" style="color:red">{{number_format($service->price)}} VND</span>
                                    </div>
                                </div>
