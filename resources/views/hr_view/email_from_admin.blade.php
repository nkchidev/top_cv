        ...
        <div class="col-md-10">
            <div class="container bootdey">
                <div class="email-app mb-4">
                    <main class="inbox">
                        <ul class="messages">
                            @foreach ($email_from_admin as $email)
                                <li class="message unread">
                                    <a href="{{ route('email.from.admin.detail', [$email->id, $email->title]) }}">
                                        <div class="actions">
                                        ...
                                        <div class="header">
                                            ...
                                            <span class="date">
                                                <span class="fa fa-paper-clip"></span> {{ $email->created_at }}</span>
                                        </div>
                                        <div class="title" style="color:black;font-size:17px">
                                            {{ $email->title }}
                                        </div>
