                            ...
                            <li class="menu" id="submenu">
                                ...
                                <ul class="submenu">
                                    <li class="list_nav_hr_view_item">
                                        <a href="{{ route('hr.index') }}"><i class="fa-regular fa-file"></i> Bảng
                                            tin</a>
                                    </li>
                                    <li class="list_nav_hr_view_item">
                                        <a href="{{ route('show.posted.view') }}" class="icon_link"><i
                                                class="fa-regular fa-pen-to-square"></i>Tin Tuyển Dụng</a>
                                    </li>
                                    <li class="list_nav_hr_view_item">
                                        <a href="{{ route('list.applicants.accepted') }}" class="icon_link"><i
                                                class="fa-regular fa-user"></i>Quản lý CV</a>

                                    </li>
                                    <li class="list_nav_hr_view_item">
                                        <a href="{{ route('create.company.view') }}" class="icon_link"><i
                                                class="fa-solid fa-gear"></i>Cài đặt tài khoản</a>
                                    </li>
                                    <li class="list_nav_hr_view_item">
                                        <a href="{{ route('email.from.admin') }}" class="icon_link"><i
                                                class="fa-regular fa-bell"></i>Hệ thống thông báo</a>
                                    </li>
