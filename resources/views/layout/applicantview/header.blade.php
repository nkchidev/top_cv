                        ...
                        <ul class="list-menu">
                            ...
                            <div class="toast"
                                style="position: fixed;
                                    ...
                                    margin: 20px;
                                    z-index: 9999;"
                                role="alert" id="email_notify" aria-live="assertive" aria-atomic="true">
                                <style>
                                ...
                                <div class="toast-header">
                                    <img src="https://static.topcv.vn/v4/image/logo/topcv-logo-tet-holiday.png"
                                        class="rounded me-2" alt="..." height="36px">
                            ...
                            <li class="menu" id="submenu">
                                ...
                                <ul class="submenu">
                                    <li class="list_nav_hr_view_item">
                                        <a href="{{ route('applicantView') }}"><i class="fa-regular fa-file"></i>Tạo
                                            CV</a>
                                    </li>
                                    <li class="list_nav_hr_view_item">
                                        <a href="{{ route('applicant.index.view') }}" class="icon_link"><i
                                                class="fa-regular fa-user"></i>CV của tôi</a>
                                    </li>
                                    <li class="list_nav_hr_view_item">
                                        <a href="{{ route('jobs.apply.view') }}" class="icon_link"><i
                                                class="fa-regular fa-pen-to-square"></i>Việc đã ứng tuyển</a>
                                    </li>
                                    <li class="list_nav_hr_view_item">
                                        <a href="{{ route('save.post.view') }}" class="icon_link"><i
                                                class="fa-solid fa-gear"></i>Việc đã lưu</a>
                                    </li>
                                    <li class="list_nav_hr_view_item">
                                        <a href="{{ route('logout') }}" class="icon_link"><i
                                                class="fa-regular fa-sign-out"></i>Đăng xuất</a>
                                    </li>
                                </ul>
                                <style>
                                    .submenu {
                ...
                success: function(data) {
                    ...
                    for (let i = 0; i < $list_messages_not_seen.length; i++) {
                        $list_messages_not_seen[i].addEventListener('click', function() {
                            ...
                            $.ajax({
                                url: '{{ route('update.status.message.applicant') }}',
                                type: 'GET',
                                dataType: 'json',
                                data: {
