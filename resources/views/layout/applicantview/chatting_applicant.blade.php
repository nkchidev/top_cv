            ...
            <div id="profile">
                <div class="wrap">
                    @if (session('avatar') != null)
                        <img id="profile-img" src="{{ asset('storage/' . session('avatar')) }}" alt=""
                            class="online" style="width:45px;height:45px;">
                    @endif
                    ...
                    <ul>
                        @foreach ($rooms_chat_of_applicant as $room_chat)
                            ...
                            <div class="wrap">
                                ...
                                <img src="{{ asset('storage/' . $room_chat->company_logo) }}" alt=""
                                    style="width:45px;height:45px;" />
                    ...
                    for (var i = 0; i < list_contact.length; i++) {
                        list_contact[i].addEventListener('click', function() {
                            ...
                            $.ajax({
                                ...
                                success: function(data) {
                                    console.log('data.data_html.applicant', data.data_html);
                                    $('.content').html(data.data_html);
                                },
                                error: function(error) {
                                    console.log('error from chat_applicant', error);
                                }
                            });
